...
public class OnboardingRequest {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    ProcessEngineConfiguration cfg = new StandaloneProcessEngineConfiguration()
      ...
      .setJdbcUrl("jdbc:postgresql://localhost/jbpm")
      //.setJdbcUsername("sa")
    ...
    Deployment deployment = repositoryService.createDeployment().addClasspathResource("processes/onboarding.bpmn20.xml").deploy();
